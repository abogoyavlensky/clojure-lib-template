...
[![CI](https://github.com/{{ username }}/{{ project-name }}/actions/workflows/snapshot.yaml/badge.svg?branch=master)](https://github.com/{{ username }}/{{ project-name }}/actions/workflows/snapshot.yaml)
